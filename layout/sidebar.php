<div class="w3-gray" style="position:absolute; width:20%; height:100%">
    ...
    <div class="w3-padding-left">
        <table style="margin-left:20px">
            <tr>
                <td style="width:50px"><a href="#" ><i  class = "fa fa-home w3-padding" style="font-size:26px;"></i></a></td>
            ...
            <tr>
                <td style="width:50px"><a href="#" ><i  class = "fa fa-power-off w3-padding" style="font-size:26px;"></i></a></td>
